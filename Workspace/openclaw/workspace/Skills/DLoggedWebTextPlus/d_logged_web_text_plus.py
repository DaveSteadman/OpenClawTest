#!/usr/bin/env python3
"""DLoggedWebTextPlus - Domain-aware content-focused web text extraction and link following."""
...
def write_log(data_root, domain, start_url, start_summary, start_words, results, words_per_page):
    now = dt.datetime.now()
    year = now.strftime("%Y")
    ...
    log_dir = os.path.join(data_root, "datastore", domain, year, month, day)
