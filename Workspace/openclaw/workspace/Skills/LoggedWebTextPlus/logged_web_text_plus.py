#!/usr/bin/env python3
"""LoggedWebTextPlus - Start from a URL, follow page links, and log per-link summaries."""
...
def write_log(data_root, start_url, start_summary, start_words, results, words_per_page):
    now = dt.datetime.now()
    year = now.strftime("%Y")
...
def main():
    parser = argparse.ArgumentParser(
        description="Start from a URL, follow page links, extract summaries, and log to datastore"
    )
